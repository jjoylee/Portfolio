namespace Lib.Payment.Wechatpay.Service
{
    ...
    public class NotifyService : INotifyService
    {
        ...
        public void Notify()
        {
            Notify notify = new Notify(WechatPayGatewayService.GetAll());
        ...
        private bool Notify_PaySucceed(object sender, PaySucceedEventArgs e)
        {
            ...
            var orderItem = OrderDao.FindById(pgCommonResultItem.OrderId);
            ...
            int fee = ((int)notifyResponse.TotalAmount / 100);
